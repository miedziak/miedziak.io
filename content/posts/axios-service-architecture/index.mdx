...
You can find working example based on react and create-react-app here: [https://github.com/miedziak/axios-services-architecture-example](https://github.com/miedziak/axios-services-architecture-example)
